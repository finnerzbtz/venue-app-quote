...
| 4 | Auth & Accounts | Sign up, login, email verification, password reset |
...
By proceeding with the first payment, both parties agree to the terms outlined in this document.
